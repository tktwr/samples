...
# *sample_py.numpy.array_1d_float*
...
# *sample_py.numpy.linspace*
# https://note.nkmk.me/python-numpy-arange-linspace/
def f_linspace():
    print(np.linspace(0.0, 1.0, 5))


# *sample_py.numpy.reshape*
def f_reshape():
    x = np.arange(6)
    print(f"x = {x}")
